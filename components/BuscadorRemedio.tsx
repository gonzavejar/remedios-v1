...
// Campo de búsqueda con autocompletado y tolerancia a typos.
  ...
  return (
    <div className="relative">
      ...
      {sugerencia && !abierto && query.length > 2 && (
        <button
          onClick={() => { setQuery(sugerencia); setSeleccionado(false); setSugerencia(null) }}
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-gray-500 truncate">
                    {r.principios}{r.dosis_forma ? ` · ${r.dosis_forma}` : ''}
                  </p>
                </div>
                <div className="flex-shrink-0 text-right">
                  ...
                  {r.precio_cenabast
                    ? <p className="text-sm font-bold" style={{ color: '#0B5966' }}>{clp(r.precio_cenabast)}</p>
                    : r.precio_lista
